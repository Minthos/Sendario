...
//    glm::mat4 view = glm::lookAt(glm::vec3(200.00,150,150), glm::vec3(0,0,0), glm::vec3(0,1,0));
    glm::mat4 view = glm::lookAt(glm::vec3(2000.00,1500,1500), glm::vec3(0,0,0), glm::vec3(0,1,0));
